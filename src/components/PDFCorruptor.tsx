...
export type Strategy = 'HEADER' | 'ENTROPY' | 'XREF';
...
interface PDFCorruptorProps {
  strategy?: Strategy;
  setStrategy?: (strategy: Strategy) => void;
}

export default function PDFCorruptor({ strategy: externalStrategy, setStrategy: externalSetStrategy }: PDFCorruptorProps = {}) {
  const [internalStrategy, setInternalStrategy] = useState<Strategy>('ENTROPY');
  const strategy = externalStrategy || internalStrategy;
  const setStrategy = externalSetStrategy || setInternalStrategy;
