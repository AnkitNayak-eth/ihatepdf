          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-white/5">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-4xl font-black text-white tracking-tight uppercase italic underline decoration-brand/30 underline-offset-8">THE PAGE SHUFFLER</h1>
              </div>
              <p className="text-zinc-500 text-lg">
                Completely randomize the order of pages in your document to induce maximum confusion.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 xl:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Chaos Sorter</h3>
              <p className="text-zinc-300 text-sm leading-relaxed mb-6">
                Turns a perfectly structured 50-page corporate report into a maddening, incomprehensible puzzle.
              </p>
              ...
              <div className="space-y-5">
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-black/40 border border-white/5 hover:border-brand/30 transition-colors">
                      ...
                      <div>
                          ...
                          <p className="text-zinc-300 text-xs leading-relaxed">Confusing reviewers or making a simple report incredibly difficult to follow.</p>
                      </div>
                  </div>
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-black/40 border border-white/5 hover:border-brand/30 transition-colors">
                      <FileWarning className="text-brand shrink-0" size={18} />
                      <div>
                          ...
                          <p className="text-zinc-300 text-xs leading-relaxed">"The merger tool must have gotten the sequence out of order when combining the chapters."</p>
                      </div>
                  </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                ...
                <div className="space-y-6">
                    <div>
                        <p className="text-xs font-black text-white uppercase mb-2">Fisher-Yates Algorithm</p>
                        <p className="text-zinc-300 text-xs leading-relaxed">
                            The Shuffler utilizes the standard Fisher-Yates algorithm to ensure a perfectly random distribution of the original pages. No two shuffles are the same.
                        </p>
                    </div>
                    <div>
