...
import { ArrowLeft, Maximize2, Zap, ShieldCheck, Database, LayoutGrid } from 'lucide-react';
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 xl:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Circumvention Protocols</h3>
              <p className="text-zinc-500 text-sm leading-relaxed mb-6">
                Most web servers have a "Maximum Upload Size" limit. By inflating your PDF to be just under or slightly over this limit, you can trigger specific server-side behaviors:
              </p>
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-black/40 border border-white/5">
                    ...
                    <div>
                        <p className="text-white text-xs font-bold mb-1 uppercase tracking-widest">Technique 01</p>
                        <p className="text-zinc-500 text-[11px] leading-tight text-white/60">Large files often time-out the portal's virus scanner, leading to a "Scan Skipped" status.</p>
                    </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-black/40 border border-white/5">
                    <ShieldCheck className="text-brand shrink-0" size={18} />
                    <div>
                        <p className="text-white text-xs font-bold mb-1 uppercase tracking-widest">Technique 02</p>
                        <p className="text-zinc-500 text-[11px] leading-tight text-white/60">Extremely large files can overflow internal buffers, causing the recipient's email client to crash.</p>
                    </div>
                </div>
              </div>
            </div>
